<!-- 我的 -->
<template>
	<div class="page-layer footer-page" style="overflow-y: auto; height: auto;">
			...
			<article class="user-content">
				<article class="user-header item padding">
					...
					<article class="header-bottom">
						<section class="pull-left">余额：<span>¥{{(userInfo.balance * 1).toFixed(2)}}</span></section>
						<section class="pull-right">
							<!--<router-link to="/user/balance" class="details">明细</router-link>-->
							<!-- <a href="javascript:cJs.message('此功能暂未开放');" class="details">明细</a> -->
							<router-link to="/user/deposit" class="drawings">提现</router-link>
						</section>
					</article>
				...
				<article class="user-tab item">
					...
					<!-- <router-link to="/user/statisticAnalysis"><img src="../../images/mine_tongji@2x.png" /><span>统计分析</span></router-link> -->
					<a href="javascript:cJs.message('此功能暂未开放');"><img src="../../images/mine_tongji@2x.png" /><span>统计分析</span></a>
					<router-link to="/user/salesRank"><img src="../../images/mine_rank@2x.png" /><span>销售排行</span></router-link>
					<!-- <router-link to="/user/salesSummary"><img src="../../images/mine_daily@2x.png" /><span>每日汇总</span></router-link> -->
					<a href="javascript:cJs.message('此功能暂未开放');"><img src="../../images/mine_daily@2x.png" /><span>每日汇总</span></a>
					<router-link to="/checking/"><img src="../../images/mine_account@2x.png" /><span>对账</span></router-link>
