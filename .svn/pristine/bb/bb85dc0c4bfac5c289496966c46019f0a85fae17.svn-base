...
export const purchaserAPI = {
	...
	/*采购商修改默认地址*/
	editAdressAPI : (...v) => https.commAjax(cJs.apiDataReturnParams("post", "/purchaser/remark-delivery-address", v)),
}
...
export const supplierAPI = {
	...
	/*供应商 审核*/
	supplierAuditAPI : (...v) => https.commAjax(cJs.apiDataReturnParams("post", "/supplier/forbidden", v)),
	/*供应商 开启*/
	supplierOpenAPI : (...v) => https.commAjax(cJs.apiDataReturnParams("post", "/supplier/active", v)),
	/*供应商详情*/
	...
	/*设置区域及分类*/
	settingBSAPI : (...v) => https.commAjax(cJs.apiDataReturnParams("post", "/supplier/setting-business-scope", v)),
	/*获取商品分类*/
	categorysByAreasAPI : (...v) => https.commAjax(cJs.apiDataReturnParams("post", "/supplier/business-scope-cateory", v)),
}
...
export const circleAPI = {
	...
	/*获取所以供应商*/
	allSupplierAPI : (...v) => https.commAjax(cJs.apiDataReturnParams("post", "/stationCircle/supplier-list", v)),
	/*所有驿站*/
	allStationAPI : (...v) => https.commAjax(cJs.apiDataReturnParams("post", "/stationCircle/station-list", v)),
	/*所有配送商*/
	allDeliveryAPI : (...v) => https.commAjax(cJs.apiDataReturnParams("post", "/stationCircle/delivery-dealer-list", v)),
}
