...
<template>
	<page-layer :narData="narData" classs="back-color padd">
		...
		<el-row class="search-wrap">
			<el-col :span="2" style="">
				<el-button @click="addStairCategory()" class="btn-add"  size="small" >添加一级分类</el-button>
			</el-col>
			<el-col :span="2" style="margin-left:20px;">
				<el-button type="primary" @click="zoom" class="btn-zoom"  size="small" >{{defautShow?'收起':'展开'}}</el-button>
			</el-col>
		</el-row>
		<!-- 商品分类列表 -->
