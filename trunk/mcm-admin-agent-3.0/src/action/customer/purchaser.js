...
export default{
	...
	editAdress(vm) {
		var _that = this;
		purchaserAPI.editAdressAPI({
			purchaserId:vm.dialogData.purchaserId,
			defaultDeliveryAddress:vm.dialogData.adress
		}, (result) => {
				vm.$message("修改成功！");
				vm.dialogData.dialogShow = false;
				_that.getPurchaserList(vm);
			});
