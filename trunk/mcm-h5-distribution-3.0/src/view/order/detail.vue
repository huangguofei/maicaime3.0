<template>
	<article class="page-layer">
		<div class=" order-details padding" :class="{padding_bottom:orderData.statusId==30}" v-if="orderData.statusText">
			...
			<footer v-if="orderData.statusId==40 ">
				<a href="javascript:;" class="pull-right affirm" @click="confirmDelivery">确认送达</a>
			</footer>
		</div>
	...
	export default {
		...
		methods: {
			...
			affirm() {
				...
				orderApi.orderDelivery(this,this.orderData.orderId);
			}
		},
		components: {
			loading
