<template>
	<article class="food-list shop-details gap" v-if="foodData">
		<header class="padding bk-white">
			...
			<h3 class="ellipsis pull-left">{{foodData.purchaserName}}</h3>
			<a class="pull-right"  @click="callPhone(foodData.receiverMobile)" href="javascript:void(0)"><img src="../../images/order_details_tele.png" /></a>
		</header>
		<ul class="padding">
